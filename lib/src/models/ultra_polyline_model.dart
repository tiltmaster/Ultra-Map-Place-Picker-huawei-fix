...
class UltraPolylineModel {
  ...
  UltraPolylineModel({required this.polylineId,  this.color,  this.geodesic,  this.jointType,
     required this.points, this.visible,  this.width,  this.zIndex,  this.onClick});
