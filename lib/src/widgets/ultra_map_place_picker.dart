...
class UltraMapPlacePicker extends StatelessWidget {
  ...
  Widget build(final BuildContext context) {
    return Stack(
      children: <Widget>[
              ...
              child: SizedBox(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      PinWidgetSelector(pinBuilder: pinBuilder,),
                    ],
                  ))),
        if (!fullMotion) ...[
          buildMapWidgetSelector(),
        ...
        PlaceBuilderSelector(hidePlaceDetailsWhenDraggingPin: hidePlaceDetailsWhenDraggingPin,outsideOfPickAreaText: outsideOfPickAreaText,
          selectedPlaceWidgetBuilder: selectedPlaceWidgetBuilder, pickArea: pickArea,
          onPlacePicked: onPlacePicked,selectedText: selectText,
        ),

        MapIcons(appBarKey: appBarKey, enableMapTypeButton:enableMapTypeButton,onMyLocation: onMyLocation,onToggleMapType: onToggleMapType,
  ...
  Widget buildMapWidgetSelector()=>MapWidgetSelector(initialTarget: initialTarget,
      searchByCameraLocation: _searchByCameraLocation,
      onMoveStart: onMoveStart, onMapCreated: onMapCreated,
      onPlacePicked: onPlacePicked, debounceMilliseconds: debounceMilliseconds,
      usePinPointingSearch: usePinPointingSearch, selectInitialPosition: selectInitialPosition,
      language: language, pickArea: pickArea,
      hidePlaceDetailsWhenDraggingPin: hidePlaceDetailsWhenDraggingPin,
      onCameraMoveStarted: onCameraMoveStarted, onCameraMove: onCameraMove,
      onCameraIdle: onCameraIdle, selectText: selectText,
      zoomGesturesEnabled: zoomGesturesEnabled, zoomControlsEnabled: zoomControlsEnabled,
      isHuaweiDevice: isHuaweiDevice, initialZoomValue: initialZoomValue, polygons: polygons, polylines: polylines);
