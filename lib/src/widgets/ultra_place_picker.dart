...
import 'package:ultra_map_place_picker/src/widgets/ultra_map_place_picker.dart';

class UltraPlacePicker extends StatefulWidget {
...
class PlacePickerState extends State<UltraPlacePicker> {
