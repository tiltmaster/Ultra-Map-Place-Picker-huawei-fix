...
class MapIcons extends StatelessWidget {
  ...
  const MapIcons({super.key, required this.appBarKey,required  this.enableMapTypeButton,
    required  this.enableMyLocationButton,required  this.onToggleMapType,required  this.onMyLocation});
