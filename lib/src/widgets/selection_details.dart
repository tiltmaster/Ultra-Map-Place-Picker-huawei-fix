...
class SelectionDetails extends StatelessWidget {
  ...
  const SelectionDetails({super.key, required this.result, required this.pickArea, required this.selectText,
    required this.outsideOfPickAreaText, required this.onPlacePicked});
